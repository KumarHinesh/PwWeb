...
public class FormCrf2DTO {

    List<MuacCrf2> muacCrf2List;
    List<PwHeightCrf2> pwHeightCrf2List;
    List<PwWeightCrf2> pwWeightCrf2List;
    private Integer id;
    private String q02;
    private String q03;
    private String q17;
    ...
    public List<MuacCrf2> getMuacCrf2List() {
        return muacCrf2List;
    }

    public void setMuacCrf2List(List<MuacCrf2> muacCrf2List) {
        this.muacCrf2List = muacCrf2List;
    }

    public List<PwHeightCrf2> getPwHeightCrf2List() {
        return pwHeightCrf2List;
    }

    public void setPwHeightCrf2List(List<PwHeightCrf2> pwHeightCrf2List) {
        this.pwHeightCrf2List = pwHeightCrf2List;
    }

    public List<PwWeightCrf2> getPwWeightCrf2List() {
        return pwWeightCrf2List;
    }

    public void setPwWeightCrf2List(List<PwWeightCrf2> pwWeightCrf2List) {
        this.pwWeightCrf2List = pwWeightCrf2List;
    }
}
